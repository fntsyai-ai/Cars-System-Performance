...
export default async function DealsPage({
  ...
  return (
    <div className="px-10 py-8 max-w-[1600px]">
      <header className="mb-10 flex items-end justify-between rise rise-0">
        <div>
        ...
        <div className="flex items-end gap-6">
          <div className="text-right">
            ...
            <div className="font-display text-[42px] text-ink-900 tabular leading-none mt-1">
              {deals.length}
            </div>
      ...
      <section className="rise rise-1">
        <div className="mb-5 flex items-end justify-between">
          <div>
            ...
            <h2 className="font-display text-[36px] leading-none text-ink-900">
          ...
          <div className="text-right">
            ...
            <div className="font-display text-[24px] text-ink-900 leading-none mt-1">
              {formatDayParam(day)}
            </div>
            <div className="eyebrow mt-2">
